...
def basicTopo():
  ...
  net.addLink(s1,s2,port1=3,port2=1, bw=500, delay=25, loss=5, jitter=15) #Add more stuff here
  net.addLink(s1,s3,port1=2,port2=1, bw=1000, delay=1, loss=0.00001, jitter=1)
  net.addLink(s2,s3,port1=2,port2=3, bw=500, delay=25, loss=5, jitter=15)
...
if __name__ == '__main__':
  ...
  try:
    data = [{"sw_id_src": "of:0000000000000001","sw_id_dst": "of:0000000000000002","port_numb_src": 3,"port_numb_dst": 1,"bandwith": 500000000,
             "latency": 25,"jitter": 15,"loss_prob": 5,"energy_consumption": 138}
            ,{"sw_id_src": "of:0000000000000002","sw_id_dst": "of:0000000000000001","port_numb_src": 1,"port_numb_dst": 3,"bandwith": 500000000,
              "latency": 25,"jitter": 15,"loss_prob": 5,"energy_consumption": 138}
            ,{"sw_id_src": "of:0000000000000001","sw_id_dst": "of:0000000000000003","port_numb_src": 2,"port_numb_dst": 1,"bandwith": 1000000000,
              "latency": 1,"jitter": 1,"loss_prob": 0.00001,"energy_consumption": 658}
            ,{"sw_id_src": "of:0000000000000003","sw_id_dst": "of:0000000000000001","port_numb_src": 1,"port_numb_dst": 2,"bandwith": 1000000000,
              "latency": 1,"jitter": 1,"loss_prob": 0.00001,"energy_consumption": 658}
            ,{"sw_id_src": "of:0000000000000002","sw_id_dst": "of:0000000000000003","port_numb_src": 2,"port_numb_dst": 3,"bandwith": 500000000,
              "latency": 25,"jitter": 15,"loss_prob": 5,"energy_consumption": 138}
            ,{"sw_id_src": "of:0000000000000003","sw_id_dst": "of:0000000000000002","port_numb_src": 3,"port_numb_dst": 2,"bandwith": 500000000,
              "latency": 25,"jitter": 15,"loss_prob": 5,"energy_consumption": 138},]
